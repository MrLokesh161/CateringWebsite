      ...
      t = function (e, s) {
        ...
        for (var w in s)
          if (
            ...
            s[w] === window ||
            s[w] === document ||
            ("undefined" != typeof Dom7 && s[w] instanceof Dom7) ||
            ("undefined" != typeof jQuery && s[w] instanceof jQuery)
          )
            v[w] = s[w];
          else {
            v[w] = {};
          ...
          (b.container[0].swiper = b),
            ...
            (b.updateClasses = function () {
              ...
              if (
                (b.params.loop &&
                  0 === r.length &&
                  ((r = b.slides.eq(-1)), r.addClass(b.params.slidePrevClass)),
                s.loop &&
                ...
                "custom" === b.params.paginationType &&
                  ...
                  (b.paginationContainer.html(
                    b.params.paginationCustomRender(b, i + 1, n),
                  ),
                ...
                if (
                  ...
                  if (b.params.freeModeMomentum) {
                    ...
                    if (u < b.maxTranslate())
                      ...
                      b.params.freeModeMomentumBounce
                        ? (u - b.minTranslate() > g && (u = b.minTranslate() + g),
                          (m = b.minTranslate()),
                          (c = !0),
                          (B = !0))
                        : (u = b.minTranslate());
              ...
              b.isHorizontal() ? (s = b.rtl ? -e : e) : (r = e),
                ...
                b.params.virtualTranslate ||
                  (b.support.transforms3d
                    ...
                    : b.wrapper.transform("translate(" + s + "px, " + r + "px)")),
                ...
                if (b.params.lazyLoadingInPrevNext)
                  if (
                    ...
                    var s = b.params.lazyLoadingInPrevNextAmount,
                      r = t,
                      i = Math.min(
                        b.activeIndex + r + Math.max(s, r),
                        b.slides.length,
                      ),
                      n = Math.max(b.activeIndex - Math.max(r, s), 0);
                    for (e = b.activeIndex + t; e < i; e++)
                      b.slides[e] && b.lazy.loadImageInSlide(e);
                ...
                function s(a) {
                  (e =
                    ...
                    (i && "container" !== b.params.controlBy) ||
                      ...
                      (i = (e - b.minTranslate()) * r + a.minTranslate())),
          ...
          Normalizations: {
            ...
            register: function () {
              function a(a, b, c) {
                var d =
                  "border-box" ===
                  z.getPropertyValue(b, "boxSizing").toString().toLowerCase();
                if (d === (c || !1)) {
                  var e,
                    f,
                    g = 0,
              ...
              if (p <= 8) e = o.css(a, c);
                ...
                if (!f) {
                  if (
                    "height" === c &&
                    "border-box" !==
                      z.getPropertyValue(a, "boxSizing").toString().toLowerCase()
                  ) {
                    var k =
                      a.offsetHeight -
